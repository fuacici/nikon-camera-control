namespace CameraControl.Devices.Example
{
  partial class Form1
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.cameraDeviceManagerBindingSource = new System.Windows.Forms.BindingSource(this.components);
      this.connectedDevicesBindingSource = new System.Windows.Forms.BindingSource(this.components);
      ...
      // 
      // connectedDevicesBindingSource
      // 
      this.connectedDevicesBindingSource.DataMember = "ConnectedDevices";
      this.connectedDevicesBindingSource.DataSource = this.cameraDeviceManagerBindingSource;
      // 
      // groupBox1
      // 
      ...
      // img_photo
      // 
      this.img_photo.Location = new System.Drawing.Point(245, 72);
    ...
    private System.Windows.Forms.BindingSource connectedDevicesBindingSource;
    private System.Windows.Forms.BindingSource cameraDeviceManagerBindingSource;
